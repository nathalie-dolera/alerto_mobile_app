...
import { Appearance, Image, Modal, ScrollView, StyleSheet, Text, TouchableOpacity, useColorScheme, View } from "react-native";
  ...
  return (
    ...
    >
      ...
      <SettingsCard>
        <SettingsRow
          icon="car.fill"
          title="Switch to Commuter"
          type="link"
          isLast={true}
          onPress={async () => {
            await updateUser({ purpose: 'commuter' });
            router.replace('/(tabs)');
          }}
        />
      </SettingsCard>
      ...
      <TouchableOpacity
        style={[styles.logoutButton, { backgroundColor: colors.logoutBackground, borderColor: colors.logoutBorder }]}
